...
[![](images/healy.png){width="40%"}](https://plain-text.co/)
...
- Son archivos que permiten **compilar texto y código en un mismo documento**. 

:::{.incremental style="font-size: 35px"}
- Ventajas:

  - Eficiencia: No hay que copiar y pegar resultados de análisis, sino que todo se trabaja en un único archivo.

  - Actualizable: Al cambiar los datos o el código, el documento se actualiza automáticamente al renderizarlo de nuevo.

  - Reproducibilidad: Cualquier persona puede ejecutar el documento y obtener los mismos resultados, siempre que tenga acceso a los datos y al código. 
:::
...
- Renderizado a pdf, word y otros formatos de salida
